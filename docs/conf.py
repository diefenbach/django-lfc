# -*- coding: utf-8 -*-
#
# LFC - Lightning Fast CMS documentation build configuration file, created by
...
project = u'LFC - Lightning Fast CMS'
copyright = u'2014, Kai Diefenbach'
...
htmlhelp_basename = 'LFC-LightningFastCMSdoc'
...
latex_documents = [
  ('index', 'LFC-LightningFastCMS.tex', u'LFC - Lightning Fast CMS Documentation',
